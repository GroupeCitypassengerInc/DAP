...
local curl = '/usr/bin/curl --retry 3 --retry-delay 5 --fail -m 10 --connect-timeout 10 -s --post301 -d "[ %s ]" "%s/index.php?digilan-token-action=write&digilan-token-secret=%s"'
